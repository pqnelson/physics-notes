...
\end{theorem}
(The $\firstClassHamiltonian$ is called the \define{First-Class Hamiltonian}\index{Hamiltonian!First-Class}{First-Class Hamiltonian|textbf}, c.f. \Mref{defn:constrained:first-class}.)
\begin{proof}
We see explicitly
\begin{equation}
  \begin{split}
