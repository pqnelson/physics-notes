...
\end{xca}
\begin{defn}\label{defn:total-hamiltonian}
...
\begin{defn}\label{defn:extended-hamiltonian}
The \define{Extended Hamiltonian} is 
\begin{equation*}
...
\begin{thm}\label{thm:dirac-bracket:addlProperties}
...
\N{Eliminating Second-Class Constraints}
