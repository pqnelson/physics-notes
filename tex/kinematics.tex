...
\begin{defn}
We also have the \define{Tangent Acceleration} which describes the
...
relative to that observer, or simply \define{Relative Velocity}.
\end{defn}

\begin{defn}
An observer, equipped with (in principle) a meter stick and a stopwatch,
forms a \define{Frame of Reference} (or a ``\textit{Reference Frame\/}'').
\end{defn}
\begin{rmk}
