...
\usepackage{braket}
\ifsvmono\else\usepackage[top=6pc,textheight=8.9in,textwidth=33pc,inner=6pc,marginparwidth=9pc,marginparsep=1.5pc]{geometry}\fi
...
\ifsvmono\else
  ...
  \titleformat*{\subsubsection}{\bfseries\sffamily}\fi
