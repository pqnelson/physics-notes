...
\def\chunkprefix{\@ifundefined{chapter}{%
  ...
  \ifnum\value{chapter}>0 \oldstylenums{\arabic{chapter}}.\else\oldstylenums{\arabic{section}}\fi
}}
...
\newtheorem{thm}[chunk@ctr]{Theorem}
\newtheorem{lemma}[chunk@ctr]{Lemma}
\newtheorem{prop}[chunk@ctr]{Proposition}
\newtheorem{cor}[chunk@ctr]{Corollary}

\theoremstyle{defnstyle}
\newtheorem{xca}[chunk@ctr]{Exercise}
\newtheorem{defn}[chunk@ctr]{Definition}
